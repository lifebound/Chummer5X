...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(
                          _currentCharacter!.name.isNotEmpty
                      ...
                      if (_currentCharacter!.alias.isNotEmpty) ...[
  ...
  Future<void> _loadCharacterFile() async {
    ...
    try {
      ...
      if (filePath != null) {
        final character = await ChumerXmlService.parseCharacterFile(filePath);
        if (character != null) {
          setState(() {
